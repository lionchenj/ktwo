...
//忘记交易密码
public async forgetGesturePassword(name:string, identity_card:string, mobile:string, verification_code:string, gesture_password:string, regesture_password:string): Promise<void> {
    const params = {
        gesture_password: gesture_password,
        regesture_password: regesture_password
    }
