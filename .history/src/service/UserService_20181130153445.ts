...
//银行卡
public async addPayment  (number: string,gesture_password:string,activation_code:string,service:number): Promise<void> {
    const params = {
        number:number,
        gesture_password:gesture_password
    }
...
//新增银行卡
public async activate_move(account: string,gesture_password:string): Promise<void> {
    const params = {
        number:number,
        gesture_password:gesture_password,
        activation_code:activation_code,
