...
export class Change extends React.Component<ChangeProps, ChangeState> {
    ...
    public render() {
        let thiswindow.localStorage.getItem('mobile');
        // const refUrl = `https://www.bst123456.com/change?mobile=${this.state.userInfo&&this.state.userInfo.mobile}`
        const refUrl = `http://dev110.weibanker.cn/chenjj/www/ktwo/build/index.html?mobile=${this.state.userInfo&&this.state.userInfo.mobile}`
