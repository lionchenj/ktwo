...
export class Change extends React.Component<ChangeProps, ChangeState> {
    ...
    public render() {
        let thisMobile = UserStorage.getCookie('mobile');
        ...
        return (
            <div className="change-container">
                ...
                <Tabs tabs={tabs} initialPage={mobile!=''?1:0}>
                    ...
                    <div style={{height: bodyHeight, backgroundColor: '#f5f5f5' }}>
                        <List className="change-list">
                            <InputItem placeholder="请输入个数" type="number"
                                ...
                                >转出通证个数</InputItem>
                            <InputItem placeholder="请输入接收人手机号" value={this.state.phone} type="number" maxLength={} onChange={this.onPhoneBlur} >收证人手机号</InputItem>
