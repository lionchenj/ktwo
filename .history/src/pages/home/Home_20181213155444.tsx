...
export class Home extends React.Component<HomeProps, HomeState> {
    ...
    public componentDidMount() {
        ...
        if (query.change) {
            this.props.history.push("/change",{mobile:query.mobile})
            return;
        }
        if (query.mobile) {
            this.props.history.push("/register",{mobile:query.mobile})
            return;
        }
    ...
    public render() {
        ...
        //     }
        //   }else{
            banners.push(<div><img className="banner-img" src={banner1} /></div><div><img className="banner-img" src={banner2} /></div>)
        //   }
        return (
