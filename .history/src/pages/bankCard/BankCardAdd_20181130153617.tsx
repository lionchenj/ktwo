            ...
            <div className="">
                <NavBar icon={<Icon type="left" />} 
                    ...
                    <List renderHeader={() => ''} className="content-item-border">
                        <InputItem labelNumber={6} type="text" placeholder="请输入真实姓名" onBlur={this.onBankNameBlur}>姓名</InputItem>
                    
                        <InputItem labelNumber={6} type="text" placeholder="请再次输入身份证号" onBlur={this.onBankid}>身份证号</InputItem>
