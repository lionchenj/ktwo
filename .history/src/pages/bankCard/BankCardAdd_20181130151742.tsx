...
interface BankCardAddForgetProps {
    history: History
}

interface BankCardAddForgetState {
    codeCountDown: number,
    changeL:boolean
}

export class BankCardAddForget extends React.Component<BankCardAddForgetProps, BankCardAddForgetState> {
    ...
    constructor(props: BankCardAddForgetProps) {
        super(props)
