            ...
            <div className="">
                <NavBar icon={<Icon type="left" />} 
                    ...
                    <List renderHeader={() => ''} className="content-item-border">
                        <InputItem labelNumber={6} type="text" placeholder="请输入银行名" onBlur={this.onBankNameBlur}>银行名</InputItem>
                    
                        <InputItem labelNumber={6} type="digit" placeholder="请输入银行卡号" onBlur={this.onBankid}>银行卡号</InputItem>
                    
                    </List>
                    <WhiteSpace size="lg" />
                    <WhiteSpace size="lg" />
                    <div className="fans-footer">
                        <Button className="login-button" onClick={this.onSubmit}</Button>
                    </div>
            </div>
        )
    }
