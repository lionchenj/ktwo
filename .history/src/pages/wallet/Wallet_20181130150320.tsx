...
export class Wallet extends React.Component<WalletProps, WalletState> {
    ...
    onSubmit = () => {
        ...
        UserService.Instance.assets_move(this.state.selectedCoinId, this.state.changeCoin, this.WalletNumber, this.gesturePasswords, this.bankName, this.state.service).then(() => {
            UIUtil.hideLoading();
            Modal.alert('提示', '提取成功', [{
                text: 'ok', onPress: () => {
                    this.props.history.goBack()
                    ...
                    <div style={{ height: bodyHeight, backgroundColor: '#f5f5f5' }}>
                        <WingBlank>
                            ...
                            <List className="change-list">
                                <InputItem labelNumber={6} placeholder="请输入银行名称" type="text" onBlur={this.onbankNameBlur}></InputItem>
                                <InputItem labelNumber={6} placeholder="请输入银行卡号" type="text" onBlur={this.onbankIdBlur}></InputItem>
                            </List>
                            <WhiteSpace size="lg" />
                            <WhiteSpace size="lg" />
                            {/* <div className='wallet-list-title'>矿工费</div>
