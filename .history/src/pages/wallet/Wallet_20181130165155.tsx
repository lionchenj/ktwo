...
export class Wallet extends React.Component<WalletProps, WalletState> {
    ...
    onSubmit = () => {
        ...
        UserService.Instance.assets_move(this.state.selectedCoinId, this.state.changeCoin, this.WalletNumber, this.gesturePasswords, this.state.bankName, this.bankId, this.state.service).then(() => {
            UIUtil.hideLoading();
            Modal.alert('提示', '提取成功', [{
                text: 'ok', onPress: () => {
                    this.props.history.goBack()
