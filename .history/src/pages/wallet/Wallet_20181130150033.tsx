                    ...
                    <div style={{ height: bodyHeight, backgroundColor: '#f5f5f5' }}>
                        <WingBlank>
                            ...
                            <List className="change-list">
                                <InputItem labelNumber={6} placeholder="请输入银行名称" type="text" onBlur={this.onAddressBlur}></InputItem>
                                <InputItem labelNumber={6} placeholder="请输入银行卡号" type="text" onBlur={this.onAddressBlur}></InputItem>
                            </List>
                            <WhiteSpace size="lg" />
                            <WhiteSpace size="lg" />
                            {/* <div className='wallet-list-title'>矿工费</div>
