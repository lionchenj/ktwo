                    ...
                    <div style={{ height: bodyHeight, backgroundColor: '#f5f5f5' }}>
                        <WingBlank>
                            ...
                            <List className="change-list">
                                <InputItem labelNumber={6} placeholder="请输入银行名称" type="text" onBlur={this.o nbankNameBlur}></InputItem>
                                <InputItem labelNumber={6} placeholder="请输入银行卡号" type="text" onBlur={this.bankId}></InputItem>
                            </List>
                            <WhiteSpace size="lg" />
                            <WhiteSpace size="lg" />
                            {/* <div className='wallet-list-title'>矿工费</div>
