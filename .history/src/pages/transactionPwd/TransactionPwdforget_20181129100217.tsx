            ...
            <div className="">
                <NavBar icon={<Icon type="left" />} 
                    ...
                    <List renderHeader={() => ''} className="content-item-border">
                        <InputItem labelNumber={6} type="text" placeholder="请输入真实姓名" onBlur={this.onPasswordBlur}>姓名</InputItem>
                    
                        <InputItem labelNumber={6} type="text" placeholder="请再次输入身份证号" onBlur={this.onConfirmPasswordBlur}>身份证号</InputItem>
                    
                        <InputItem labelNumber={6} type="phone" placeholder="请输入手机号码" onBlur={this.onPasswordBlur}>手机号码</InputItem>
