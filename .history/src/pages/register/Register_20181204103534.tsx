            ...
            <div className="login-container">
                ...
                <Flex direction="column">
                    ...
                    <div className="content">
                        ...
                        <List className="content-item-border">
                            <InputItem type="phone" maxLength={11} placeholder={this.state.changeL?"请输入分享人手机号":"Phone number of the sharer"} onBlur={this.onSharePhoneBlur} defaultValue={this.mobile}></InputItem>
                        </List>
