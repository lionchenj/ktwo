...
export class Register extends React.Component<Props, RegisterState> {
    ...
    public render() {
        ...
        const mobile = this.props.location.state.messageType
                ...
                <Flex direction="column">
                    ...
                    <div className="content">
                        <List className="content-item-border">
                            <InputItem name="phone" type="digit" maxLength={11}  placeholder={this.state.changeL?"请输入手机号":"Your phone number"} onBlur={this.onPhoneBlur}></InputItem>
                        </List>
                        <List className="content-item-border">
                            <InputItem  type="number" placeholder={this.state.changeL?"请输入短信验证码":"SMS code"} onBlur={this.onCodeBlur}
                        ...
                        <List className="content-item-border">
                            <InputItem type="text" maxLength={11} placeholder={this.state.changeL?"请输入激活码":"Activation coder"} onBlur={this.onActivationBlur} defaultValue={query.mobile}></InputItem>
                        </List>
                        <List className="content-item-border">
                            <InputItem type="password" placeholder={this.state.changeL?"请输入登录密码":"Password"} onBlur={this.onPasswordBlur}></InputItem>
                        </List>
                        <List className="content-item-border">
                            <InputItem type="phone" maxLength={11} placeholder={this.state.changeL?"请输入分享人手机号":"Phone number of the sharer"} onBlur={this.onSharePhoneBlur} defaultValue={query.mobile}></InputItem>
                        </List>
