        ...
        return (
            <div className="fans-container updataPwd">
                ...
                <List className="content-item-border">
                    <InputItem type="digit" maxLength={11}  placeholder="请输入手机号":"Your phone number"} onBlur={this.onPhoneBlur}></InputItem>
                </List>
                <List className="content-item-border">
                    <InputItem placeholder="请输入短信验证码":"SMS code"} onBlur={this.onCodeBlur}
                ...
                <List className="content-item-border">
                    <InputItem type="password" placeholder="请输入登录密码":"Password"} onBlur={this.onPasswordBlur}></InputItem>
                </List>
                <List className="content-item-border">
                    <InputItem type="password" placeholder="请确认登录密码":"Confirm Password"} onBlur={this.onConfirmPasswordBlur}></InputItem>
                </List>
                <WhiteSpace size="lg" />
                <WhiteSpace size="lg" />
