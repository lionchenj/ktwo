  ...
  return (function(t) {
    ...
    function(t, e, n) {
      var r = n(2),
        ...
        c = function(t, e, n) {
          ...
          p && (n = e);
          for (a in n)
            ((f = !l && _ && void 0 !== _[a]) && a in m) ||
              ((s = f ? _[a] : n[a]),
              (m[a] =
                p && "function" != typeof _[a]
                  ? n[a]
                  : v && f
                  ? i(s, r)
                  : y && _[a] == s
    ...
    function(t, e, n) {
      ...
      function o(t, e, n) {
        ...
        return { x: 2 * (e - r.left), y: 2 * (n - r.top) };
      }
      function i(t, e) {
        var n = e.x - t.x,
          r = e.y - t.y;
            ...
            (0, b["default"])(t, [
              {
                ...
                value: function() {
                  ...
                  (i.width = i.height = 2 * Math.min(r, o)),
                    t.customStyle ||
                      (0, y["default"])(i.style, {
                        position: "absolute",
                        top: "50%",
                                  ...
                                  (_ = new p["default"](function(n, r) {
                                    ...
                                    var o = function i(r) {
                                      if (
                                        ...
                                        var o = null;
                                        y.length < l.minPoints &&
                                          (o = new Error(
                                            t.ERR_NOT_ENOUGH_POINTS
                                          ));
                                        var u = {
                                          err: o,
                                          records: y
    ...
    function(t, e, n) {
      ...
      var o = n(41),
        ...
        E = r(w),
        O = {
          update: { beforeRepeat: function() {}, afterRepeat: function() {} },
        ...
        j = (function(t) {
          function e() {
            ...
            return (
              (0, v["default"])(this, e),
              (t.update = (0, h["default"])({}, O.update, t.update)),
              (t.check = (0, h["default"])({}, O.check, t.check)),
              (0, m["default"])(
                this,
                (e.__proto__ || (0, l["default"])(e)).call(this, t)
              )
            );
          }
          return (
                        ...
                        function(r) {
                          for (;;)
                            switch ((r.prev = r.next)) {
                              ...
                              case 4:
                                return (
                                  (t = this.options.update.beforeRepeat),
                                  (n = this.options.update.afterRepeat),
                                  (r.next = 7),
                                  this.record()
                                );
                              case 7:
                                if (
                                  ((o = r.sent),
                                  !o.err ||
                                    o.err.message !== e.ERR_USER_CANCELED)
                                ) {
                                  r.next = 10;
                                  break;
                                }
                              ...
                              case 10:
                                ...
                                return (
                                  this.update(),
                                  t.call(this, o),
                                  r.abrupt("return", c["default"].resolve(o))
                                );
                              case 14:
                                return (
                                  t.call(this, o), (r.next = 17), this.record()
                                );
                              case 17:
                                if (
                                  ((u = r.sent),
                                  !u.err ||
                                    u.err.message !== e.ERR_USER_CANCELED)
                                ) {
                                  r.next = 20;
                                  break;
                                }
                              ...
                              case 20:
                                return (
                                  u.err ||
                                    o.records === u.records ||
                                    (u.err = new Error(
                                      e.ERR_PASSWORD_MISMATCH
                                    )),
                                  this.update(),
                                  n.call(this, u),
                                  r.abrupt("return", c["default"].resolve(u))
                                );
                              case 24:
                              case "end":
                                return r.stop();
    ...
    function(t, e, n) {
      t.exports = { default: n(71), __esModule: !0 };
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
      ...
      t.exports =
        ...
        n(10)(function() {
          ...
          ? function(t, e) {
              for (
                var n = u(t), a = arguments.length, f = 1, s = o.f, l = i.f;
                a > f;
    ...
    function(t, e, n) {
      ...
      E ||
        ...
        (k = function() {
          var t = new r();
          (this.promise = t),
            (this.resolve = a(A, t, 1)),
            (this.reject = a(L, t, 1));
        })),
        s(s.G + s.W + s.F * !E, { Promise: b }),
        n(19)(b, "Promise"),
        n(97)("Promise"),
        (i = n(0).Promise),
        s(s.S + s.F * !E, "Promise", {
    ...
    function(t, e, n) {
      ...
      var r = n(2),
        ...
        X = function(t) {
          ...
          return (
            !(this === U && o(I, t) && !o(G, t)) &&
            (!(e || !o(this, t) || !o(I, t) || (o(this, A) && this[A][t])) || e)
          );
        },
        V = function(t, e) {
          if (((t = b(t)), (e = x(e, !0)), t !== U || !o(I, e) || o(G, e))) {
            var n = P(t, e);
            return (
              !n || !o(I, e) || (o(t, A) && t[A][e]) || (n.enumerable = !0), n
            );
          }
        },
        Z = function(t) {
          for (var e, n = T(b(t)), r = [], i = 0; n.length > i; )
            o(I, (e = n[i++])) || e == A || e == a || r.push(e);
          return r;
        },
        $ = function(t) {
          for (
            var e, n = t === U, r = T(n ? G : b(t)), i = [], u = 0;
            r.length > u;

          )
            !o(I, (e = r[u++])) || (n && !o(U, e)) || i.push(I[e]);
          return i;
        };
      H ||
        ((M = function() {
          ...
          return i && K && B(U, t, { configurable: !0, set: e }), Y(t);
        }),
    ...
    function(t, e) {
      ...
      function u() {
        v &&
          h &&
          ((v = !1), h.length ? (d = h.concat(d)) : (y = -1), d.length && c());
      }
      function c() {
        if (!v) {
          var t = o(u);
    ...
    function(t, e, n) {
      (function(e) {
        ...
        if (((r.regeneratorRuntime = void 0), (t.exports = n(114)), o))
          ...
          function f(t) {
            function e(n, r, i, u) {
              ...
              if ("throw" !== c.type) {
                var a = c.arg,
                  f = a.value;
                return f && "object" == typeof f && _.call(f, "__await")
          ...
          function s(t, e, n) {
            ...
            return function(i, u) {
              ...
              for (n.method = i, n.arg = u; ; ) {
                ...
                "throw" === f.type &&
                  ((r = P), (n.method = "throw"), (n.arg = f.arg));
              }
            };
          }
          function l(t, e) {
            ...
            if ("throw" === r.type)
              return (
                (e.method = "throw"), (e.arg = r.arg), (e.delegate = null), R
              );
            var i = r.arg;
            return i
              ? i.done
            ...
            (O.mark = function(t) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((t.__proto__ = c), w in t || (t[w] = "GeneratorFunction")),
            ...
            (d.prototype = {
              ...
              abrupt: function(t, e) {
                ...
                return (
                  ...
                  (i.arg = e),
                  o
                    ? ((this.method = "next"), (this.next = o.finallyLoc), R)
                    : this.complete(i)
                );
              },
              ...
              finish: function(t) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                  ...
                  if (n.finallyLoc === t)
                    return this.complete(n.completion, n.afterLoc), h(n), R;
                }
              },
              catch: function(t) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
